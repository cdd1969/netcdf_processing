...
def create_depth_averaged_nc(nc_in,
    ...
    for v in var_list:
        ...
        # get coordinate attribute and get rid of the first dimension (z)
        if coord_attr in var.ncattrs():
            if isinstance(var.getncattr(coord_attr), (str, unicode)):
                new_coords = var.getncattr(coord_attr).split()[1::]
